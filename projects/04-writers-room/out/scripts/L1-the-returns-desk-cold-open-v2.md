...
2. **As Installed.** A grandmother returns a stepladder that is one rung taller every morning, and Ines traces the extra rungs to a grandfather building his grandson a way up to the treehouse at night without wanting the credit, which she files under kindness and hates.
3. **Aisle 12.** Teddy returns his own flashlight for showing him eyes at the dark end of the paint aisle, Marguerite walks him down while Ines works the geometry from the desk, and the eyes turn out to be reflective safety stickers on the top shelf, on the same night Mr. Quayle returns a rake with a receipt for a hose.
...
5. **Not On The Chart.** A couple returns a paint chip that glows after dark, Teddy confesses he mislabeled the glow primer on his first night, Marguerite processes him as a return with a story, and Ines notices the blank tag for the first time.
...
7. **Wrong Door.** A renter returns a key that opens the wrong door, Ines proves it opens every door in the building and is the master key a landlord lost in the mailroom a week ago, and when she asks Marguerite about the blank tag to her face, the only answer is "Pending."
