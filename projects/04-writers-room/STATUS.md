...
- Reviews: standards PASS on all eight scripts (v2, and v3 for the Recent History Society trailer); expression-level IP check CLEAR after two rename rounds (D-024, D-026); punch-up change notes in `out/scripts/change-notes.md`.
