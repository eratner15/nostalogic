...
Personas and jobs to be done. Written from Phase 1 evidence. Every number cites a file in `projects/01-market/out/`.
Short form: E1 = `evidence-h1-h3-h5.md`, E2 = `evidence-h2-h4-history.md`, L = `landscape.md`.

## 1. The household

The unit of measurement is the household: one parent account plus the people who watch with it.
...
Name for internal use: the Porch Parent.
...
Jobs to be done:
1. Give me one night a week where the whole family sits on one couch and laughs at the same thing.
2. Let me hand my kid a screen ritual I am proud of, not one I apologize for.
3. Let me share a piece of my own childhood without showing my kid a 30-year-old rerun.
4. Make it easy. Tell me when, tell me what, and give me something to do after.

## 3. Child persona

Name for internal use: the Stay-Up Kid.
...
Jobs to be done:
1. Let me stay up for something that feels like mine.
2. Give me characters I can talk about at school.
3. Let me be a little scared, then laugh.
4. Do not make me wait through something for babies.

## 4. The co-viewing moment

The moment the block serves: one fixed night, one screen, one couch, both generations.

- Before: the parent gets the reminder through a parent-facing channel, not a platform notification (L, section 9). The ritual kit sets up a snack and one activity.
- During: four slots in one sitting. The parent laughs at the Anchor. The child leans in at Lights Out. Hosts carry the family across the gaps.
- After: one conversation prompt per episode. The parent gets the next-week hook by email.
